...
func (p RDSPlugin) MetricKeyPrefix() string {
	if p.Prefix == "" {
		p.Prefix = "rds"
	}
	return p.Prefix
...
func (p RDSPlugin) FetchMetrics() (map[string]interface{}, error) {
