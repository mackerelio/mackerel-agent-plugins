...
func (m JVMPlugin) GraphDefinition() map[string](mp.Graphs) {
	...
	return map[string](mp.Graphs){
		...
		fmt.Sprintf("jvm.%s.new_space", lowerJavaName): mp.Graphs{
			...
			Unit:  "float",
			Metrics: [](mp.Metrics){
				mp.Metrics{Name: "NGCMX", Label: "New max", Diff: false, Scale: 1000},
				mp.Metrics{Name: "NGC", Label: "New current", Diff: false, Scale: 1000},
				mp.Metrics{Name: "EU", Label: "Eden used", Diff: false, Scale: 1000},
				mp.Metrics{Name: "S0U", Label: "Survivor0 used", Diff: false, Scale: 1000},
				mp.Metrics{Name: "S1U", Label: "Survivor1 used", Diff: false, Scale: 1000},
			},
		},
		...
		fmt.Sprintf("jvm.%s.perm_space", lowerJavaName): mp.Graphs{
			...
			Unit:  "float",
			Metrics: [](mp.Metrics){
				mp.Metrics{Name: "PGCMX", Label: "Perm max", Diff: false, Scale: 1000},
				mp.Metrics{Name: "PGC", Label: "Perm current", Diff: false, Scale: 1000},
				mp.Metrics{Name: "PU", Label: "Perm used", Diff: false, Scale: 1000},
			},
		},
	}
}
