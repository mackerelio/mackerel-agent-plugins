...
func TestPluginTypeOption(t *testing.T) {
	...
	// Specify type option
	var fluentd FluentdMetrics = FluentdMetrics{pluginType: "mackerel"}
	stat, err := fluentd.parseStats(fluentdStats)
...
func TestPluginIDPatternOption(t *testing.T) {
	...
	// Specify type option
	pluginIDPattern, _ := regexp.Compile("^match")
	var fluentd FluentdMetrics = FluentdMetrics{pluginIDPattern: *pluginIDPattern}
	stat, err := fluentd.parseStats(fluentdStats)
