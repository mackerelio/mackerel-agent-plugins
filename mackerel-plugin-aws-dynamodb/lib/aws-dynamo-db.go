...
func (p DynamoDBPlugin) GraphDefinition() map[string]mp.Graphs {
	...
	var graphdef = map[string]mp.Graphs{
		...
		"ThrottledRequests": {
			...
			Unit:  "integer",
			Metrics: []mp.Metrics{
				{Name: "ThrottleRequests.PutItem", Label: "PutItem", Stacked: true},
				{Name: "ThrottleRequests.DeleteItem", Label: "DeleteItem", Stacked: true},
				{Name: "ThrottleRequests.UpdateItem", Label: "UpdateItem", Stacked: true},
				{Name: "ThrottleRequests.GetItem", Label: "GetItem", Stacked: true},
				{Name: "ThrottleRequests.BatchGetItem", Label: "BatchGetItem", Stacked: true},
				{Name: "ThrottleRequests.Scan", Label: "Scan", Stacked: true},
				{Name: "ThrottleRequests.Query", Label: "Query", Stacked: true},
				{Name: "ThrottleRequests.BatchWriteItem", Label: "BatchWriteItem", Stacked: true},
			},
		},
		"SystemErrors": {
