...
%changelog
* Tue Jun 9 2026 <mackerel-developers@hatena.ne.jp> - 0.91.0
- Add -tls-skip-verify flag to nginx plugin (by fujiwara)
...
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump github.com/redis/go-redis/v9 from 9.19.0 to 9.20.0 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 3 updates (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.301.0 to 1.303.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.41.0 to 1.41.1 (by dependabot[bot])
- Bump golang.org/x/text from 0.36.0 to 0.37.0 in the golang-x group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.300.0 to 1.301.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump github.com/redis/go-redis/v9 from 9.18.0 to 9.19.0 (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.40.0 to 1.41.0 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.298.0 to 1.299.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/Azure/go-ntlmssp from 0.1.0 to 0.1.1 (by dependabot[bot])
- use a cloudwatch:GetMetricData on mackerel-plugin-aws-ec2-ebs (by yseto)
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.297.1 to 1.298.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
...
- Bump golang.org/x/text from 0.35.0 to 0.36.0 in the golang-x group across 1 directory (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.39.0 to 1.40.0 (by dependabot[bot])

* Mon Apr 13 2026 <mackerel-developers@hatena.ne.jp> - 0.90.1
- Use Go 1.26 for builds, supports Go 1.25 and above. (by ne-sachirou)
- Bump the mackerelio group across 4 directories with 4 updates (by dependabot[bot])
- Bump github.com/lib/pq from 1.12.1 to 1.12.3 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.296.2 to 1.297.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/mackerelio/go-mackerel-plugin from 0.1.5 to 0.1.6 in the mackerelio group across 1 directory (by dependabot[bot])
- Bump github.com/lib/pq from 1.12.0 to 1.12.1 (by dependabot[bot])
- Bump github.com/fsouza/go-dockerclient from 1.13.0 to 1.13.1 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 3 updates (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.38.1 to 1.39.0 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.296.1 to 1.296.2 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/montanaflynn/stats from 0.8.2 to 0.9.0 (by dependabot[bot])
- Bump actions/setup-go from 6.3.0 to 6.4.0 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump github.com/moby/moby/v2 from 2.0.0-beta.6 to 2.0.0-beta.8 (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.37.1 to 1.38.1 (by dependabot[bot])
- Bump github.com/lib/pq from 1.11.2 to 1.12.0 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.294.1 to 1.296.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump google.golang.org/grpc from 1.56.3 to 1.79.3 in /mackerel-plugin-gcp-compute-engine (by dependabot[bot])
- Bump github.com/go-ldap/ldap/v3 from 3.4.12 to 3.4.13 (by dependabot[bot])
- fix tests (by yseto)
- Bump github.com/montanaflynn/stats from 0.7.1 to 0.8.2 (by dependabot[bot])
- Bump actions/download-artifact from 8.0.0 to 8.0.1 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump golang.org/x/text from 0.34.0 to 0.35.0 in the golang-x group across 1 directory (by dependabot[bot])
- Bump github.com/mackerelio/go-osstat from 0.2.6 to 0.2.7 in the mackerelio group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.293.1 to 1.294.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
...
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.291.0 to 1.293.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump actions/download-artifact from 7.0.0 to 8.0.0 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump github.com/redis/go-redis/v9 from 9.17.3 to 9.18.0 (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.37.0 to 1.37.1 (by dependabot[bot])
- Bump filippo.io/edwards25519 from 1.1.0 to 1.1.1 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates (by dependabot[bot])
- Bump filippo.io/edwards25519 from 1.1.0 to 1.1.1 in /mackerel-plugin-mysql (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 3 updates (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.289.0 to 1.289.1 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/lib/pq from 1.11.1 to 1.11.2 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates (by dependabot[bot])
- Bump golang.org/x/text from 0.33.0 to 0.34.0 in the golang-x group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.286.0 to 1.287.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.285.0 to 1.286.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/fsouza/go-dockerclient from 1.12.3 to 1.13.0 (by dependabot[bot])
- Bump github.com/lib/pq from 1.10.9 to 1.11.1 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.284.0 to 1.285.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/redis/go-redis/v9 from 9.17.2 to 9.17.3 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.283.0 to 1.284.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.282.0 to 1.283.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.281.0 to 1.282.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.280.0 to 1.281.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump actions/checkout from 6.0.1 to 6.0.2 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.279.2 to 1.280.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/gosnmp/gosnmp from 1.43.1 to 1.43.2 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.279.1 to 1.279.2 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump actions/setup-go from 6.1.0 to 6.2.0 (by dependabot[bot])
- Bump golang.org/x/text from 0.32.0 to 0.33.0 in the golang-x group across 1 directory (by dependabot[bot])
- Bump github.com/gosnmp/gosnmp from 1.42.1 to 1.43.1 (by dependabot[bot])
- Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates (by dependabot[bot])
- Bump shogo82148/actions-setup-perl from 1.36.0 to 1.37.0 (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.278.0 to 1.279.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
- Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.277.0 to 1.278.0 in the aws-aws-sdk-go-v2 group across 1 directory (by dependabot[bot])
