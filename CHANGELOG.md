...
* Bump the mackerelio group across 4 directories with 4 updates #1462 (dependabot[bot])
* Bump github.com/lib/pq from 1.12.1 to 1.12.3 #1461 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.296.2 to 1.297.0 in the aws-aws-sdk-go-v2 group across 1 directory #1460 (dependabot[bot])
* Bump github.com/mackerelio/go-mackerel-plugin from 0.1.5 to 0.1.6 in the mackerelio group across 1 directory #1458 (dependabot[bot])
* Bump github.com/lib/pq from 1.12.0 to 1.12.1 #1457 (dependabot[bot])
* Bump github.com/fsouza/go-dockerclient from 1.13.0 to 1.13.1 #1456 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 3 updates #1455 (dependabot[bot])
* Bump shogo82148/actions-setup-perl from 1.38.1 to 1.39.0 #1454 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.296.1 to 1.296.2 in the aws-aws-sdk-go-v2 group across 1 directory #1453 (dependabot[bot])
* Bump github.com/montanaflynn/stats from 0.8.2 to 0.9.0 #1452 (dependabot[bot])
* Bump actions/setup-go from 6.3.0 to 6.4.0 #1451 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates #1450 (dependabot[bot])
* Bump github.com/moby/moby/v2 from 2.0.0-beta.6 to 2.0.0-beta.8 #1449 (dependabot[bot])
* Bump shogo82148/actions-setup-perl from 1.37.1 to 1.38.1 #1448 (dependabot[bot])
* Bump github.com/lib/pq from 1.11.2 to 1.12.0 #1447 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.294.1 to 1.296.0 in the aws-aws-sdk-go-v2 group across 1 directory #1446 (dependabot[bot])
* Bump google.golang.org/grpc from 1.56.3 to 1.79.3 in /mackerel-plugin-gcp-compute-engine #1444 (dependabot[bot])
* Bump github.com/go-ldap/ldap/v3 from 3.4.12 to 3.4.13 #1443 (dependabot[bot])
* fix tests #1442 (yseto)
* Bump github.com/montanaflynn/stats from 0.7.1 to 0.8.2 #1441 (dependabot[bot])
* Bump actions/download-artifact from 8.0.0 to 8.0.1 #1440 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates #1439 (dependabot[bot])
* Bump golang.org/x/text from 0.34.0 to 0.35.0 in the golang-x group across 1 directory #1438 (dependabot[bot])
* Bump github.com/mackerelio/go-osstat from 0.2.6 to 0.2.7 in the mackerelio group across 1 directory #1437 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.293.1 to 1.294.0 in the aws-aws-sdk-go-v2 group across 1 directory #1436 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates #1435 (dependabot[bot])
* Bump actions/setup-go from 6.2.0 to 6.3.0 #1434 (dependabot[bot])
* Bump actions/upload-artifact from 6.0.0 to 7.0.0 #1433 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/setup-go-matrix.yml from 1.8.0 to 1.9.0 #1432 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/go-lint.yml from 1.8.0 to 1.9.0 #1431 (dependabot[bot])
* Bump mackerelio/workflows/.github/workflows/go-test.yml from 1.8.0 to 1.9.0 #1430 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.291.0 to 1.293.0 in the aws-aws-sdk-go-v2 group across 1 directory #1429 (dependabot[bot])
* Bump actions/download-artifact from 7.0.0 to 8.0.0 #1428 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates #1426 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates #1425 (dependabot[bot])
* Bump github.com/redis/go-redis/v9 from 9.17.3 to 9.18.0 #1424 (dependabot[bot])
* Bump shogo82148/actions-setup-perl from 1.37.0 to 1.37.1 #1423 (dependabot[bot])
* Bump filippo.io/edwards25519 from 1.1.0 to 1.1.1 #1422 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates #1421 (dependabot[bot])
* Bump filippo.io/edwards25519 from 1.1.0 to 1.1.1 in /mackerel-plugin-mysql #1420 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 3 updates #1419 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.289.0 to 1.289.1 in the aws-aws-sdk-go-v2 group across 1 directory #1418 (dependabot[bot])
* Bump github.com/lib/pq from 1.11.1 to 1.11.2 #1417 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates #1416 (dependabot[bot])
* Bump golang.org/x/text from 0.33.0 to 0.34.0 in the golang-x group across 1 directory #1415 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.286.0 to 1.287.0 in the aws-aws-sdk-go-v2 group across 1 directory #1414 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.285.0 to 1.286.0 in the aws-aws-sdk-go-v2 group across 1 directory #1413 (dependabot[bot])
* Bump github.com/fsouza/go-dockerclient from 1.12.3 to 1.13.0 #1412 (dependabot[bot])
* Bump github.com/lib/pq from 1.10.9 to 1.11.1 #1411 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.284.0 to 1.285.0 in the aws-aws-sdk-go-v2 group across 1 directory #1410 (dependabot[bot])
* Bump github.com/redis/go-redis/v9 from 9.17.2 to 9.17.3 #1409 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.283.0 to 1.284.0 in the aws-aws-sdk-go-v2 group across 1 directory #1408 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.282.0 to 1.283.0 in the aws-aws-sdk-go-v2 group across 1 directory #1407 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.281.0 to 1.282.0 in the aws-aws-sdk-go-v2 group across 1 directory #1406 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.280.0 to 1.281.0 in the aws-aws-sdk-go-v2 group across 1 directory #1405 (dependabot[bot])
* Bump actions/checkout from 6.0.1 to 6.0.2 #1404 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.279.2 to 1.280.0 in the aws-aws-sdk-go-v2 group across 1 directory #1403 (dependabot[bot])
* Bump github.com/gosnmp/gosnmp from 1.43.1 to 1.43.2 #1402 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.279.1 to 1.279.2 in the aws-aws-sdk-go-v2 group across 1 directory #1401 (dependabot[bot])
* Bump actions/setup-go from 6.1.0 to 6.2.0 #1400 (dependabot[bot])
* Bump golang.org/x/text from 0.32.0 to 0.33.0 in the golang-x group across 1 directory #1399 (dependabot[bot])
* Bump github.com/gosnmp/gosnmp from 1.42.1 to 1.43.1 #1398 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 6 updates #1397 (dependabot[bot])
* Bump shogo82148/actions-setup-perl from 1.36.0 to 1.37.0 #1396 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.278.0 to 1.279.0 in the aws-aws-sdk-go-v2 group across 1 directory #1395 (dependabot[bot])
* Bump github.com/aws/aws-sdk-go-v2/service/ec2 from 1.277.0 to 1.278.0 in the aws-aws-sdk-go-v2 group across 1 directory #1394 (dependabot[bot])
* Bump actions/upload-artifact from 5.0.0 to 6.0.0 #1393 (dependabot[bot])
* Bump actions/download-artifact from 6.0.0 to 7.0.0 #1392 (dependabot[bot])
* Bump the aws-aws-sdk-go-v2 group across 1 directory with 2 updates #1391 (dependabot[bot])
